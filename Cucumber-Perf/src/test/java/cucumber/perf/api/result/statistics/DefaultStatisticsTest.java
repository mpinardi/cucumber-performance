...
public class DefaultStatisticsTest {
	...
	public void testGetStats_Strict() {
			...
			res.add(new GroupResult("test", new Result(Type.FAILED, 1000000000L, null), LocalDateTime.parse("2007-12-12T05:22:30"),LocalDateTime.parse("2007-12-12T05:22:31")));
			...
			DefaultStatistics statistics = new DefaultStatistics(new BaseResult("sim",new Result(Result.Type.PASSED,(long)240000000, null),LocalDateTime.parse("2007-12-12T05:20:00"),LocalDateTime.parse("2007-12-12T05:24:00")),results);
	...
	public void testGetStats_Strict_MultiGroup() {
			...
			res2.add(new GroupResult("test2", new Result(Type.PASSED, 20000000000L, null), LocalDateTime.parse("2007-12-12T05:20:35"),LocalDateTime.parse("2007-12-12T05:20:55")));
			res2.add(new GroupResult("test2", new Result(Type.PASSED, 20000000000L, null), LocalDateTime.parse("2007-12-12T05:20:35"),LocalDateTime.parse("2007-12-12T05:20:55")));
			res2.add(new GroupResult("test2", new Result(Type.PASSED, 31000000000L, null), LocalDateTime.parse("2007-12-12T05:20:54"),LocalDateTime.parse("2007-12-12T05:21:25")));
			res2.add(new GroupResult("test2", new Result(Type.PASSED, 30000000000L, null), LocalDateTime.parse("2007-12-12T05:21:10"),LocalDateTime.parse("2007-12-12T05:21:40")));
	...
	public void testGetStats_Concurrency() {
			...
			res.add(new GroupResult("test", new Result(Type.PASSED, 20000000000L, null), LocalDateTime.parse("2007-12-12T05:20:35"),LocalDateTime.parse("2007-12-12T05:20:55")));
			res.add(new GroupResult("test", new Result(Type.PASSED, 20000000000L, null), LocalDateTime.parse("2007-12-12T05:20:35"),LocalDateTime.parse("2007-12-12T05:20:55")));
			res.add(new GroupResult("test", new Result(Type.PASSED, 31000000000L, null), LocalDateTime.parse("2007-12-12T05:20:54"),LocalDateTime.parse("2007-12-12T05:21:25")));
			res.add(new GroupResult("test", new Result(Type.PASSED, 30000000000L, null), LocalDateTime.parse("2007-12-12T05:21:10"),LocalDateTime.parse("2007-12-12T05:21:40")));
			results.put("test",res);
			DefaultStatistics statistics = new DefaultStatistics(new BaseResult("sim",new Result(Result.Type.PASSED,(long)120000000, null),LocalDateTime.parse("2007-12-12T05:20:00"),LocalDateTime.parse("2007-12-12T05:22:00")),results);
			Stats stats = statistics.getStats(true);
	...
	public void testGetErrors() {
		...
		res.add(new GroupResult("test", new Result(Type.PASSED, 30000000000L, null), LocalDateTime.parse("2007-12-12T05:21:10"),LocalDateTime.parse("2007-12-12T05:21:40")));
		res.add(new GroupResult("test", new Result(Type.PASSED, 32000000000L, null), LocalDateTime.parse("2007-12-12T05:22:01"),LocalDateTime.parse("2007-12-12T05:22:33")));
		GroupResult gr = new GroupResult("test", new Result(Type.FAILED, 1000000000L, new CucumberException("random error")), LocalDateTime.parse("2007-12-12T05:22:30"),LocalDateTime.parse("2007-12-12T05:22:31"));
		ScenarioResult sc = new ScenarioResult("scentest", new TestCase(4, "features/ScenTest.feature", "ScenTest 1", null, null, null), new Result(Type.FAILED, (long)1000, new Exception("Here is an error", new Throwable())), LocalDateTime.now(), LocalDateTime.now());
		sc.addChildResult(new StepResult("steptest", new TestStep(),new Result(Type.FAILED, (long)1000, new Exception("Here is an error",new Throwable())), LocalDateTime.now(), LocalDateTime.parse("2007-12-12T05:22:31")));
		sc.addChildResult(new StepResult("steptest", new TestStep(),new Result(Type.FAILED, (long)1000, new Exception("Here is 2nd error",new Throwable())), LocalDateTime.now(), LocalDateTime.parse("2007-12-12T05:22:31")));
		gr.addChildResult(sc);
		res.add(gr);
		GroupResult gr2 = new GroupResult("test", new Result(Type.FAILED, 990000000L, new CucumberException("random error")), LocalDateTime.parse("2007-12-12T05:23:35"),LocalDateTime.parse("2007-12-12T05:23:36"));
		ScenarioResult sc2 = new ScenarioResult("scentest", new TestCase(4, "features/ScenTest.feature", "ScenTest 1", null, null, null), new Result(Type.FAILED, (long)1000, new Exception("Here is an error", new Throwable())), LocalDateTime.now(), LocalDateTime.now());
		sc2.addChildResult(new StepResult("steptest", new TestStep(),new Result(Type.FAILED, (long)1000, new Exception("Here is 2nd error",new Throwable())), LocalDateTime.now(), LocalDateTime.parse("2007-12-12T05:23:36")));
