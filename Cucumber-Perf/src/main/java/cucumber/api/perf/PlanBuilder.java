...
import cucumber.api.perf.salad.AstBuilder;
import cucumber.api.perf.salad.Parser;
import cucumber.api.perf.salad.ParserException;
import cucumber.api.perf.salad.TokenMatcher;
...
public class PlanBuilder {
	...
	public void parse(Resource resource) {
		...
		try {
			...
			PerfPlan perfPlan = new PerfPlan(saladDocument, convertFileSeparatorToForwardSlash(resource.getPath()),
					gherkin);
