...
final class CucumberOptionsProvider implements CucumberOptionsAnnotationParser.OptionsProvider {
    ...
    public CucumberOptionsAnnotationParser.CucumberOptions getOptions(Class<?> clazz) {
        ...
        return new GenericCucumberOptions(annotation);
    }
    ...
    private static class GenericCucumberOptions implements CucumberOptionsAnnotationParser.CucumberOptions {
        ...
        GenericCucumberOptions(CucumberOptions annotation) {
